export default {
  'project.p001-unitableapi.name': 'Unitable',
  'project.p001-unitableapi.text.01':
    'REST API with Spring Boot, JWT and PostgreSQL for Web Development course.',
  'project.p001-unitableapi.text.02':
    'For development, some tools are used such as JPA to model the database and Lombok.',
